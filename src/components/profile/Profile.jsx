...
export default function Profile() {
  ...
  // Ensure userData is available and has the required properties
  const { name, handle, followers, avatar } = userData || {};
      ...
      <div className="display-flex">
        <div className="profile-container">
          <div className="profile-header">
            <img
              className="avatar"
              src={avatar || "https://i.pravatar.cc/150?img=5"}
              alt="Profile"
            />
            <div>
              <h2 className="username">{name || "User"}</h2>
              <p className="handle">@{handle || "username"}</p>
